...
def gerar_populacao(tam_pop, qte_genes):
    ...
    for i in range(tam_pop):
        pop.append(gerar_individuo(qte_genes))
    return pop
...
# uso: python3 one_max.py <tam_pop> <qte_genes> <taxa_crossover> <taxa_mutacao> <geracoes>
# exemplo: python3 one_max.py 10 50 0.7 0.005 100
...
for geracao in range(geracoes):
    ...
    pop = mutacao(nova_pop, tam_pop, qte_genes, taxa_mutacao)
